...
if(isset($_POST['submit-from'])) {
    ...
    $project = $_POST['interested'];
    // $agree = $_POST['checkbax'];
   
   
    // $to = "nagaraju@madworks.in,digital@srikrishnadeveloppers.com"; // Replace with the recipient's email address
    // $subject = "Lead From Krishe Pearl Website"; // Replace with the email subject
    // $body = "Name: $customerName \n Mobile Number: $mobileNumber \n Email:  $email \n Message: $message \n Project: $project"; // Replace with your email content
    // $headers = ""; // Replace with the sender's email address
...
$sql = "INSERT INTO `krishe_pearl`( `Name`, `Email`, `Mobile`, `Interested In`, `Message`, `Date`) VALUES ('$customerName','$email','$mobileNumber','$project','$message',CURTIME())";
